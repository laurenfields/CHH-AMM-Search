...
target_list_import = r"C:\Users\lawashburn\Documents\HyPep1.0\HyPep_Simple_ASMS_Results\20220429\07inclusion_list\Brain_inclusion_list.csv"#path to directory with inclusion lists
...
for zz in remaining_charges:
    ...
    file_name = sample_name + '_' + zs + '_available_spectra.csv'
    file_out_path = spectra_dir + '\\' + file_name
    with open(file_out_path,'w',newline='') as filec:
            writerc = csv.writer(filec)
            true_working_spectra2.to_csv(filec,index=False)
